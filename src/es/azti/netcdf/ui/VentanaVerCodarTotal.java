...
public class VentanaVerCodarTotal extends JFrame {
	...
	public void mostrarDatos() {
		...
		String contName = this.bean.getNetworkBean() == null?"":this.bean.getNetworkBean().getContributor_name();
		 this.addRowDisplay(tempPanel, "Contributor Names: ", this.bean.getContributor_name(),
				 this.profile==null?contName:this.profile.getContributor_name(), "Contributor_name", true, true);
		 ...
		 String contRole = this.bean.getNetworkBean() == null?"":this.bean.getNetworkBean().getContributor_role();
		 this.addRowDisplay(tempPanel, "Contributor Roles: ", this.bean.getContributor_role(),
				 this.profile==null?contRole:this.profile.getContributor_role(), "Contributor_role", true, true);
		 ...
		 String contEmail = this.bean.getNetworkBean() == null?"":this.bean.getNetworkBean().getContributor_email();
		 this.addRowDisplay(tempPanel, "Contributor Emails: ", this.bean.getContributor_email(),
				 this.profile==null?contEmail:this.profile.getContributor_email(), "Contributor_email", true, true);
